...
// import { NewDealType, NewDealInitialValuesType } from '../schemas'

// const default: NewDealInitialValuesType ={
//     name: '',
//     link: '',
//     coupon: '',
//     discount: undefined,
...
// type AddDealContextType = {
//     newDealData: NewDealInitialValuesType,
//     updateNewDealDetails: (deatails: Partial<NewDealType>)=> void;
//     dataLoaded:boolean,
//     resetLocalStorage: ()=> void;
// };
...
//     if(context === null){
//         throw new Error('useAddDealContext must be used within  a AddDealContextProvider');
//     }
//     return context;
// }