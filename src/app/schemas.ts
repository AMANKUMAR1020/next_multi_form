...
export const stepOneSchema = z.object({
    ...
    link: z.string().url('Please enter a valid URL including starting with https://'),
});
...
export const stepThreeSchema = z.object({
    contactName: z.string().min(5, 'Please enter a contact name of at least 5 characters long'),
    contectEmail: z.string().email('Please enter a valid email'),
})
